...
export default function ProjectList(props: Props) {
  const updateForm = (key: keyof ProjectForm, value: string) =>
    props.onFormChange({ ...props.projectForm, [key]: value });
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-6">
      ...
      <ProjectTable
        ...
        onEdit={props.canManage ? props.onEditProject : undefined}
      />
          ...
          <form onSubmit={props.onSubmit}>
            <div className="space-y-4">
              ...
              <Input
                ...
                value={props.projectForm.businessOwner}
                onChange={(event) => updateForm("businessOwner", event.target.value)}
              />
              <Select
                label="Status"
                value={props.projectForm.status}
            ...
            <DialogFooter>
              ...
              <Button type="submit" variant="primary" size="sm">
                {props.editingProjectId ? "Save project" : "Create project"}
              </Button>
            </DialogFooter>
          </form>
        </Dialog>
