...
const REQUEST_BODY_SCHEMAS: Record<string, string> = {
  ...
  "POST /assets": "AssetInput",
  "PUT /assets/:id": "AssetUpdateInput",
  "POST /assets/import-url": "ImportUrlInput",
  "POST /assets/:id/import-url": "ImportUrlInput",
  "POST /assets/:id/transition": "AssetTransitionInput",
  "PUT /assets/:id/model-card": "ModelCardUpdateInput",
  "POST /assets/:id/model-card/metrics": "ModelCardMetricInput",
  "PUT /assets/:id/model-card/metrics/:metricId": "ModelCardMetricInput",
  "POST /assets/:id/recertification": "RecertificationInput",
